...
import { RouteTableIcon } from '../../../assets/aws-icons';
import useDiagramStore from '../../../store/diagramStore';

// Style for Route Table node
const nodeStyle = {
  padding: '8px',
  borderRadius: '4px',
  width: '120px',
...
const RouteTableNode: React.FC<NodeProps> = ({ id, data, selected }) => {
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <RouteTableIcon color="#FF9900" size={24} />
...
export default memo(RouteTableNode); 