...
import { IGWIcon } from '../../../assets/aws-icons';
import useDiagramStore from '../../../store/diagramStore';

// Style for Internet Gateway node
const nodeStyle = {
  padding: '8px',
  borderRadius: '4px',
  width: '120px',
...
const InternetGatewayNode: React.FC<NodeProps> = ({ id, data, selected }) => {
