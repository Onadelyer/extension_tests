...
const MenuViewProvider_1 = require("./providers/MenuViewProvider");
function activate(context) {
    ...
    const provider = new MenuViewProvider_1.MenuViewProvider(context.extensionUri);
    context.subscriptions.push(vscode.window.registerWebviewViewProvider('extension-test.menuView', provider));
}
/**
